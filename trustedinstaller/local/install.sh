...
printf "The selected disk configuration was saved to /etc/nixos-bootstrap/local-device-paths.nix.\n"
printf "After login, clone the repository and follow commands.md to perform the full switch.\n"
printf "\n"
